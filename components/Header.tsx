...
const Header = () => {
  ...
  return (
    <header className="fixed bg-white flex items-center w-full h-16 px-4">
      ...
      {isMenuOpen && (
        <div className="absolute top-16 right-0 left-0 bg-black flex flex-col items-center space-y-2 md:hidden">
          <Link href="/about" className="px-2 py-1 text-purple-300 font-semibold rounded hover:bg-gray-800">
            About
          </Link>
          <Link href="/contact" className="px-2 py-1 text-purple-300 font-semibold rounded hover:bg-gray-800">
            Contact Us
          </Link>
          <Link href="/mine" className="px-2 py-1 text-purple-300 font-semibold rounded hover:bg-gray-800">
            Our Mine
          </Link>
        </div>
      )}
