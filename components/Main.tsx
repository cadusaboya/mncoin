    ...
    <div className="flex flex-col md:flex-row items-center justify-between px-8 py-16 bg-gray-100">
      <div className="flex-1 mb-8 md:mb-0 md:mr-8 px-20">
        ...
        <p className="mt-2 md:text-x1 max-w-xl text-purple-800 text-justify">
          MnCoin is a decentralized Manganese Ore Mine powered by blockchain technology. Our mission is to facilitate investments in the ore mining sector and also create a hub for buyers and sellers to trade Manganese safely.
        </p>
      </div>
