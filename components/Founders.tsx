    ...
    return (
        <div className="pb-2 pt-5 mx-8 flex flex-col items-center">
            ...
            <div className="flex flex-col md:flex-row items-stretch justify-center space-y-5 md:space-y-0 md:space-x-5 px-4 md:px-12 xl:px-36 mt-5">
                <div className="flex-1 p-5 border-4 border-purple-900 flex flex-col items-center">
                    <Image
                        src="/my-img.jpeg"
                        alt="Roadmap Image"
                        height={100}
                    ...
                    <p className="text-xl mt-4 text-purple-800 text-center px-2 text-justify">
                ...
                <div className="flex-1 p-5 border-4 border-purple-900 flex flex-col items-center">
                    ...
                    <p className="text-xl mt-10 text-purple-800 text-center px-2 mb-5 text-justify">
                ...
                <div className="flex-1 p-5 border-4 border-purple-900 flex flex-col items-center">
                    ...
                    <p className="text-xl mt-10 text-purple-800 text-center px-2 mb-5 text-justify">
                        Master in Geoprocessing Applications and Evaluation, Expertise, and Auditing of Engineering Works with over 10 years of experience in mining.
                    </p>
                </div>
                <div className="flex-1 p-5 border-4 border-purple-900 flex flex-col items-center">
                    <Image
