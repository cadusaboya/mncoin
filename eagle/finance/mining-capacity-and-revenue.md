# Mining Capacity & Revenue

The mining operation is structured to extract and sell manganese with the following parameters:

| Metric                    | Value           |
| ------------------------- | --------------- |
| Monthly Manganese Output  | 5,000 MT        |
| Price per % Grade (USD)   | $4.50           |
| Eagle Manganese Grade     | 42%             |
