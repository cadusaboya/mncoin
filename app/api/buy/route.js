...
// Usar o código que você já validou e que está a funcionar
export async function POST(req) {
  try {
    ...
    // Assinamos a transação com a chave do vendedor (tesouro).
    // O comprador (feePayer) ainda precisa de assinar.
    ...
    console.error("Erro na API /api/buy:", error);
